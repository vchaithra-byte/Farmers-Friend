...
<html lang="en">
	...
	<!-- Banner -->
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Farmer's Friend &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Be found !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farmer's Fam<span>Banglore</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">vchaithra2000@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farmer's friend</b></span>
				Farmers friend is platform where you gey all the information regarding agriculture...!
			</p>
